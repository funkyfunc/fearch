...
| Headed / human handoff | – | opt-in: installed Chrome, visible window, tool-owned profile, challenges handed to the person (rung 7b); `FEARCH_BROWSER_SESSION` decides whether the person's own cookies are sent to ordinary pages, always labelled |
